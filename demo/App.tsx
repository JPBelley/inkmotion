...
import {
  ...
  ThermalNoise, Breathing, OrbitalDrift, WeightWave, Pendulum,
...
const SPRING_COMPONENTS = {
  ...
  'orbital-drift': OrbitalDrift, 'weight-wave': WeightWave,
...
const SPRING_VARIANTS: { id: SpringKey; label: string; category: string }[] = [
  ...
  { id: 'weight-wave',       label: 'Weight Wave',      category: 'ambient' },
